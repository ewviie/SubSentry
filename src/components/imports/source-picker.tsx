...
import { CreditCard, PlayCircle, Smartphone, type LucideIcon } from "lucide-react";
...
// needs to introspect it. Enabled/disabled here mirrors each provider's own
// `enabled` flag; Apple and Google Play flip to true in Phase 2 once their
// providers are implemented, with no other change needed here.
...
export function SourcePicker({ onSelect }: { onSelect: (source: ImportSourceId) => void }) {
  return (
