  ...
  return (
    <span
      ...
      className={cn(
        ...
        "before:absolute before:inset-0 before:rounded-full before:border before:border-gold/25 before:content-['']",
        "after:absolute after:inset-0 after:animate-ping after:rounded-full after:border after:border-gold/30 after:![animation-duration:2.8s] after:motion-reduce:hidden after:content-['']",
        className
      )}
    />
  );
