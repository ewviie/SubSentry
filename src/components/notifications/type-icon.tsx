import { TrendingUp, CalendarClock, CalendarX, Clock, Copy, PiggyBank, AlertTriangle, PlugZap, SearchCheck, Wallet, type LucideIcon } from "lucide-react";
